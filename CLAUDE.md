...
this Ansible-based infrastructure deployment system.
...
- **Dynamic Detection**: Use Ansible facts for system information (IPs, interfaces,
  architecture)
...
1. Common setup (packages, Docker, network facts)
1. Service-specific configuration
1. Health checks and verification
...
1. If similar functionality exists, generalize it instead of duplicating
1. Add validation for any new required variables
1. Test with minimal configuration (no defaults)

### Refactoring Existing Code

1. Identify redundant patterns across roles
1. Extract common functionality to shared roles
1. Remove defaults and add explicit validation
1. Replace hardcoded values with dynamic facts
